...
public class List_View_Activity extends AppCompatActivity implements AbsListView.OnScrollListener, AdapterView.OnItemLongClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                New_Note_Activity.ENTER_STATE = 0;
                Intent intent = new Intent(m_context, New_Note_Activity.class);
...
//        适配器渲染list
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        New_Note_Activity.ENTER_STATE =1;
        ...
        while (cursor.moveToNext()){
            ...
            New_Note_Activity.id = Integer.parseInt(No);
            intent.putExtras(bundle);
            intent.setClass(List_View_Activity.this, New_Note_Activity.class);
            startActivityForResult(intent,1);
        }
    }
    @Override
